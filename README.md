# myldapsync - fork of pgldapsync by EnterpriseDB Corporation adopted for MySQL and MariaDB fork of pgldapsync by EnterpriseDB Corporation (work in progress)
